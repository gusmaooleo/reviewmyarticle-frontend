  ...
  return (
    <div className={cn('flex flex-col items-center gap-4', className)}>
      ...
      <div className="text-center space-y-0.5">
        <p className="text-sm font-medium">{currentFile ? 'Foto de perfil carregada' : 'Foto de perfil'}</p>
        <p className="text-xs text-muted-foreground">PNG, JPG até {formatBytes(maxSize)}</p>
      </div>
